...
By default all ports (`1-65535`) are forwarded to docker host. You may restrict ports by setting environment variable `PORTS` to a space and/or comma separated list of ports and/or port ranges e.g `443, 8000-9000`. You may also configure port mapping `CONTAINER_PORT:HOST_PORT` e.g. `443:8443, 8000-9000:5000-6000`

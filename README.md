...
Ports can be forwarded to different host's ports by setting environment variable `HOST_PORTS` to same comma separated list of ports and/or port ranges e.g `4443,7080,8000:9000`
